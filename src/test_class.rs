...
impl<B: UsbBus> TestClass<B> {
    ...
    pub fn new(alloc: &mut UsbAllocator<B>) -> TestClass<B> {
        TestClass {
            ...
            ep_bulk_in: alloc.endpoint_in(EndpointConfig::bulk(64)),
            ep_bulk_out: alloc.endpoint_out(EndpointConfig::bulk(64)),
            ep_interrupt_in: alloc.endpoint_in(EndpointConfig::interrupt(31, 1)),
            ep_interrupt_out: alloc.endpoint_out(EndpointConfig::interrupt(31, 1)),
            control_buf: [0; 256],
            bulk_buf: [0; 256],
            interrupt_buf: [0; 256],
            len: 0,
